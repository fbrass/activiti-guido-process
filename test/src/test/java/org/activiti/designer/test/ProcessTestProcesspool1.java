...
public class ProcessTestProcesspool1 {
	...
	private String filename = "C:\\Users\\gupstar\\workspace\\test\\src\\main\\resources\\diagrams\\testautoteilebestellprozess.bpmn";
	...
	@Test
	public void testUsertasksProcess() throws Exception{
		RepositoryService repositoryService = activitiRule.getRepositoryService();
		repositoryService.createDeployment().addInputStream("process_pool1.bpmn20.xml",
				new FileInputStream(filename)).deploy();
		RuntimeService runtimeService = activitiRule.getRuntimeService();
